        ...
        <div className=" grid grid-cols-1 lg:grid-cols-2 py-10 content-center">
          ...
          <div className="p-4 lg:p-20 grid grid-cols-3 gap-8">
            <Square className="col-span-3 bg-[#c7212f] h-40">
              <img src="/4.jpg" alt="4" className="mx-auto h-full" />
            </Square>
            <Square>
              <img src="/5.jpg" alt="5" className="h-40" />
            </Square>
            <Square>
              <img src="/7.jpg" alt="7" className="h-40" />
            </Square>
            <Square>
              <img src="/8.jpg" alt="8" className="h-40" />
            </Square>
            <Square>
              <img src="/9.jpg" alt="9" className="h-40" />
            </Square>
            <Square>
              <img src="/12.jpg" alt="12" className="h-40" />
            </Square>
            <Square>
              <img src="/16.jpg" alt="16" className="h-40" />
            </Square>
          </div>
        </div>
      </div>
